...
export function AppSidebar({ projects }: { projects: ProjectState }) {
  const sessionContext = authEnabled ? Session.useSessionContext() : null;
  ...
  return (
    <Sidebar collapsible="icon" data-theme="light">
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {!authEnabled ? (
                // When auth is disabled, show no account options or simplified ones
                <SidebarMenuItem>
                  <SidebarMenuButton asChild>
      ...
      <SidebarFooter className="p-1 border-t border-gray-700">
        <div className="text-center">
          <a
            href="https://buntinglabs.com"
            target="_blank"
            className="text-muted-foreground text-xs hover:underline"
          >
            {state === "collapsed" ? (
              <img
                src="/public/bunting_bird.svg"
                alt="Bunting Labs"
